...
public class SecaoC implements Secao {
	...
	public SecaoC(double larguraAlma, double alturaAlma, double larguraAbaInferior, double alturaAbaInferior,
			double larguraAbaSuperior, double alturaAbaSuperior) {
		this.larguraAlma = larguraAlma;
		this.alturaAlma = alturaAlma;
		this.larguraAbaInferior = larguraAbaInferior;
		this.alturaAbaInferior = alturaAbaInferior;
		this.larguraAbaSuperior = larguraAbaSuperior;
		this.alturaAbaSuperior = alturaAbaSuperior;
	}
